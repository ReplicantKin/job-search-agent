...
The current release asset is [job-search-agent-0.1.6.zip](https://github.com/ReplicantKin/job-search-agent/releases/download/v0.1.6/job-search-agent-0.1.6.zip).
